...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'timeline.title': { en: 'Our Love Story', km: 'រឿងស្នេហ៍របស់យើង' },
  'timeline.first_meet': { en: 'First Meeting', km: 'ការជួបគ្នាដំបូង' },
  'timeline.first_meet_desc': { en: 'We met at a friend\'s gathering and instantly felt a connection.', km: 'យើងបានជួបគ្នានៅពិធីជួបជុំមិត្តភ័ក្តិ ហើយមានអារម្មណ៍ស្និទ្ធស្នាលភ្លាមៗ។' },
  'timeline.first_date': { en: 'First Date', km: 'ណាត់ជួបដំបូង' },
  'timeline.first_date_desc': { en: 'A magical evening under the stars that we\'ll never forget.', km: 'ល្ងាចដ៏អស្ចារ្យក្រោមពន្លឺផ្កាយដែលយើងមិនអាចភ្លេចបាន។' },
  'timeline.engagement': { en: 'Engagement', km: 'ពិធីភ្ជាប់ពាក្យ' },
  'timeline.engagement_desc': { en: 'With a ring and a promise, we embarked on our forever journey.', km: 'ជាមួយចិញ្ចៀន និងការសន្យា យើងចាប់ផ្តើមដំណើរអស់មួយជីវិត។' },
  'timeline.wedding': { en: 'Wedding Day', km: 'ថ្ងៃពិធីមង្គលការ' },
  'timeline.wedding_desc': { en: 'The day we\'ve been dreaming of is finally here!', km: 'ថ្ងៃដែលយើងរង់ចាំយ៉ាងអង្វរ បានមកដល់ទីបំផុត!' },
